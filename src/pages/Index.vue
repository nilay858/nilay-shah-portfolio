  ...
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        <div class="leading-tight">Hey I'm Nilay Shah</div>
        <div
          class="text-green-700 text-3xl leading-tight"
        >Power System Dynamics, Renewable energy Integration &amp; Power System Protection</div>
      </div>
    ...
    <div class="container-inner mx-auto">
      <p class="text-xl sm:text-2xl text-justify">
        <span class="text-green-700 font-bold">Dr. Nilay N Shah</span> always knew that he was destined for a career in academia. He has a natural ability to explain abstract concepts in an engaging, interesting and thought-provoking manner. As a busy
        <span
          class="text-green-700 font-bold"
        >Professor</span>, He balance his demanding research commitments with his true love - sparking curiosity and interest through their teaching.
      </p>
      <p class="text-lg sm:text-2xl text-justify">
        <span class="text-green-700 font-bold">Dr. Nilay N Shah</span> teaches and lectures popular courses at both the
        <span
          class="text-green-700 font-bold"
        >undergraduate and postgraduate levels.</span> He also offer supervision of doctoral candidates in a number of interdisciplinary areas.
      </p>
      ...
      <div class="flex justify-between items-center py-6">
        ...
        <div class="w-1/2 px-8 hidden sm:flex justify-end">
          <g-image src="../../static/engineer.svg" alt="mobile" />
        </div>
      </div>
    </div>
    ...
    <div class="overflow-x-hidden">
      ...
      >
        <h1 class="font-bold text-4xl mb-6" id="projects">Research and Articles:</h1>
        ...
        <ul class="text-lg sm:text-2xl space-y-6">
          <li class="checkmark" v-for="(item,index) in items" :key="index">
            <div class="text-2xl underline text-justify">{{ item.title }}</div>
            <div class="text-xl mt-4 font-bold text-green-900">
              <span v-for="(author, index) in item.authors" :key="index">{{ author }} &bull; &nbsp;</span>
            </div>
            <div class="text-2xl font-extrabold text-green-600">{{ item.firm }}</div>
          </li>
        </ul>
      </div>
      <!-- end projects -->
    ...
    <div class="overflow-x-hidden">
      <div class="contact-me bg-background-secondary pt-16">
        <div class="container-inner mx-auto text-xl pb-4 relative">
          <h2 class="font-bold text-4xl mb-6" id="contact">Contact me:</h2>
      ...
      items: [
        {
          ...
          authors: ['NN Shah', 'AD Chafekar', 'DN Mehta', 'AR Suthar'],
          firm: 'International Journal of Engineering Research & Technology (IJERT) '
        },
        {
          title: 'The state space modeling of single two and three ALFC of power system using integral control and optimal LQR control method',
          authors: ['NN Shah', 'CD Kotwal'],
          firm: 'IOSR Journal of Engineering'
        },
        {
          title: 'An application of 100 MW DFIG based wind model for damping oscillation in SMIB',
          authors: ['NN Shah', 'SR Joshi', 'SS Jadav'],
          firm: '2018 IEEE Texas Power and Energy Conference (TPEC)'
        },
        {
          title: 'Utilization of DFIG‐based wind model for robust damping of the low frequency oscillations in a single SG connected to an infinite bus',
          authors: ['NN Shah', 'SR Joshi'],
          firm: 'International Transactions on Electrical Energy Systems.'
        },
        {
          title: ' Analysis, reduction and robust stabiliser design of sub-synchronous resonance in an IEEE FBM augmented by DFIG-based wind farm',
          authors: ['NN Shah', 'SR Joshi'],
          firm: 'IET Renewable Power Generation'
        },
        {
          title: 'Modal analysis for selection of DFIG-based wind farms for damping and reduction of the risk of SSR',
          authors: ['NN Shah', 'SR Joshi'],
          firm: 'IET Energy Systems Integration'
        },
        {
          title: 'Small signal stability analysis of DFIG based wind farms connected to SMIB',
          authors: ['NN Shah', 'SR Joshi'],
